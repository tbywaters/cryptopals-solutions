...
class SRPServer():
    ...
    def __init__(self, user_data, prime = NIST_PRIME, base = 2, k = 3):
    ...
    def reset_keys(self):
        ...
        #Values to be entered later are initialised as empty objects
    ...
    def send_public_params(self):
        ...
        returns:
            ...
            int: k-value used in SRP
        """
        return self.prime, self.base, self.k
    ...
    def send_dh_public_key(self):
        ...
        #key calculaton
        self.public_key = (self.k *self.v + modexp(self.base, self.secret_key, self.prime)) % self.prime
    ...
    def verify_hmac(self, recv_hmac):
        ...
        u = sha256(bso.int_to_bytes(self.client_public_key) + bso.int_to_bytes(self.public_key)).hexdigest()
        u = int(u, 16)

        S = modexp(self.client_public_key*modexp(self.v, u, self.prime), self.secret_key, self.prime)
...
class SRPServer_HTTP(SRPServer):
    ...
    def verify_hmac(self, recv_hmac):
        ...
        return SRPServer.verify_hmac(self, recv_hmac)
